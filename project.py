...
client_secrets_path = '/var/www/html/catalog_app/client_secrets.json'
client_secrets_file = open(client_secrets_path, 'r')
client_secrets_contents = client_secrets_file.read()
